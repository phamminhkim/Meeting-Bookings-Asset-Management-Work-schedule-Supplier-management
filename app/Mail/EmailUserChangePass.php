...
class EmailUserChangePass extends Mailable
{
    ...
    public function build()
    {
        ...
        ->markdown('email.user_changepass_success', ['user' => $user, 'company'=>$company, 'department'=>$department, 'password'=>$this->data->password]);
    }
}
