...
class CreateAssetInventarioDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('asset_inventario_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('asset_inventario_details');
    }
}
