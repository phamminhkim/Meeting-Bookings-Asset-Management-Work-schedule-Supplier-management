            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div v-for="(step, index) in info.steps" v-bind:key="index" id="thongtinduyet">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item align-items-center border-0 " v-for="(user, idx) in step.users"
                                v-bind:key="idx">
                                <div class="d-flex justify-content-between ">
                ...
                <div class="card-footer" v-if="!info.is_document_cancel">
                    ...
                    <button type="button" class="btn btn-success  btn-block" :disabled="loading" v-if="info.is_approve"
                        @click="approvePaymentAgree()">
                    ...
                    <button type="button" class="btn btn-default btn-block" :title="$t('form.back')">
                        <i class="fas fa-long-arrow-alt-left"></i>
                    </button>
                </div>
            </div>
            <h6 class="text-gray"> <i class="far fa-comments mr-1"></i> <strong> <i> <u>{{ $t('form.info_feedback')
            }}:</u>
                    </i> </strong> </h6>
            <ul class="list-group">
