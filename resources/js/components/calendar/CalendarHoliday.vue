            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <button  class="btn btn-info btn-sm" @click="showCalanderholiday()"> <i class="fa fa-plus"></i>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group row">
                                            ...
                                            <label class="col-form-label-sm col-md-1.5" style="text-align:left"
                                                :title="$t('form.employee_name')" for=""> Loại Ngày Nghỉ</label>
                                            <div class="col-md-3">
                                ...
                                <div class="row">
                                    <b-table ref="table" striped hover bordered responsive head-variant="light" small
                                        :fields="fields" :items="calendar_holidays" :filter="filter"
                                        :current-page="current_page" :per-page="per_page" :tbody-tr-class="rowClass">
                
                                        <template #cell(action)="data">
                                            <div class="margin">
                                                <button class="btn btn-xs" @click="editCalanderholiday(data.item)"><i
                                                        class="fas fa-edit text-green " title="Edit"></i></button>

                                                <button class="btn btn-xs" @click="deleteCalanderholiday(data.item.id)"><i
                    ...
                    <div class="modal-content">
                        <form @submit.prevent="AddGoodtypes">
                            <div class="modal-header">
                                ...
                                <h4 v-if="!edit" >Thêm Loại Ngày Nghỉ</h4>
                                <h4 v-if="edit"> Cập Nhật Loại Ngày Nghỉ</h4>
                               </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" v-model="calendarholiday.name"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="color"  v-model="calendarholiday.color"
                                      v-bind:class="hasError('color')?'is-invalid':''"
                                     required/>
                                     <span v-if="hasError('color')" class="invalid-feedback" role="alert">
...
export default {
    ...
    data() {
        return {
            ...
            edit: false,
            token: "",
            url_goodtypes: "/api/calendar/calendarholiday",
    ...
    methods: {
        ...
        AddGoodtypes() {
            ...
            if (this.edit === false) {
                fetch(page_url, {
                    method: "POST",
                    body: JSON.stringify(this.calendarholiday),
                    headers: {
                    ...
                    .then(data => {
                        ...
                        if (!data.data.errors) {
                            this.reset();
                            this.calendar_holidays.push(data.data);
                ...
                //update
                fetch(page_url + "/" + this.calendarholiday.id, {
                    method: "PUT",
                    body: JSON.stringify(this.calendarholiday),
                    headers: {
                        Authorization: this.token,
                    ...
                    .then(data => {
                        ...
                        if (!data.data.errors) {
                            ...
                            this.$set(this.calendar_holidays, this.calendarholiday.index, { ...this.calendarholiday });
        ...
        editCalanderholiday(calendarholiday) {

            let index = this.calendar_holidays.findIndex(i => {
                console.log("id" + i.id);
                return i.id == calendarholiday.id;
            });
            this.edit = true;
            this.calendarholiday.id = calendarholiday.id;
            this.calendarholiday.name = calendarholiday.name;
            this.calendarholiday.color = calendarholiday.color;
            this.calendarholiday.index = index;
            $("#AddGoodtypes").modal("show");
        },
        deleteCalanderholiday(id) {
        ...
        fetchCalanderholiday(page, search) {
            //$("#tbbody_id").html('');
            this.loading = true;
            // const this.token = "Bearer " + window.Laravel.access_this.token;
            let vm = this;
            this.calendar_holidays = Array();
            ...
            fetch(page_url, {
                ...
                .then(res => {
                    if (res.success == '1') {
                        ...
                        var list = [];
                        for (let i = 0; i < this.calendar_holidays.length; i++) {
                            list.push({
                                So_thu_tu: i,
                                Ten_hang: this.calendar_holidays[i].name,
        ...
        reset() {
            this.clearAllError();
            this.edit = false;
            for (let field in this.calendarholiday) {
                this.calendarholiday[field] = null;
            }
        },
        clearAllError() {
            this.errors = {};
    ...
    computed: {
        ...
        rows() {
            return this.calendar_holidays.length;
        },
        placeholder() {
