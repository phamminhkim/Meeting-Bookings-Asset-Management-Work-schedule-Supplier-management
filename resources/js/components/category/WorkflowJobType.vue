                ...
                <div class="modal-content">
                    <form @submit.prevent="save_and_update" @keydown="clearError">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="">Cho phép USER tự tạo</label>
                                <input type="checkbox" v-model="workflow_jobtype.is_can_be_created"
                                    class="form-control form-control-sm" />
                            </div>
                            <div class="form-group">
                                <label for="">Thuộc nhóm phản hồi hay không?</label>
                                <input type="checkbox" v-model="workflow_jobtype.is_response_type"
                                    class="form-control form-control-sm" />
                            </div>
...
export default {
    ...
    methods: {
        fetchworkflow_jobtype() {
            this.loading = true;
            var page_url = this.page_url_workflow_job_type + "?all=true";;
        ...
        editItem(item) {
            ...
            this.workflow_jobtype.is_can_be_created = item.is_can_be_created;
            this.workflow_jobtype.is_response_type = item.is_response_type;
