<template>
  <div class="modal fade" id="DialogCreateRole" tabindex="-1" role="dialog">
        ...
        <form @submit.prevent="submitDataForm" @keydown="clearError">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input v-model="role.description" type="text" class="form-control" maxlength="100"
    ...
    submitDataForm() {
      ...
      if (this.edit === false) {
        fetch(page_url, {
          ...
          .then((data) => {
            if (data.success) {
              this.$emit('onCreateRole', data.data);

              toastr.success(data.message, "Thành công");
              $("#DialogCreateRole").modal("hide");
            } else {
