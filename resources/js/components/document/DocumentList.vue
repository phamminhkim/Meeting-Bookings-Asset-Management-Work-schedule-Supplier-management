    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-sm-6">
            <create-new-menu
              url="documents?type=add&doctype="
              module="REPORT"
            ></create-new-menu>
              ...
              <div class="row">
                ...
                >
                  ...
                  <template v-slot:cell(title)="data">
                    <span>
                      <a :href="viewRequest(data.item.id)">{{ data.item.title }}</a>
                    </span>
                  </template>
...
export default {
  ...
  data() {
    return {
      ...
      edit: false,
      token: "",
      page_url_request: "/api/documents",
  ...
  methods: {
    ...
    fetDocumentType() {
     ...
     fetDocumentTypes_Tree() {
            // const this.token = "Bearer " + window.Laravel.access_this.token;
            var page_url = this.page_url_document_type + "?module=REPORT&type=tree_combobox";
            fetch(page_url, { headers: { Authorization: this.token } })
                .then((res) => res.json())
                .then((res) => {
                    //console.log("Xin chao");
        ...
        fetDocbrowserTypes_Tree() {
            // const this.token = "Bearer " + window.Laravel.access_this.token;
            var page_url = this.page_url_docbrowser_type + "?type=tree_combobox";
            fetch(page_url, { headers: { Authorization: this.token } })
                .then((res) => res.json())
                .then((res) => {
                    //console.log("Xin chao");
            ...
            for (let i = 0; i < this.requests.length; i++) {
              ...
              list.push({
                ...
                Loại_chứng_từ: this.get_document_type_name(
                 ...
                 docbrowser_type:this.get_documentbrowser_type_name(
                   this.requests[i].docbrowser_type
                 ),
    ...
    viewRequest(id) {
      return "documents?type=view&id=" + id;
      // window.location.href= "documents?type=view&id="+id;
    },
      viewTeam(id) {
    ...
    printRequest() {
      ...
      var id = this.selected;
      window.location.href = "documents?type=print&id=" + id;
    },
    ...
    cancelRequest() {
      ...
      this.$bvModal
        ...
        .then((value) => {
          if (value) {
            var page_url = "/api/documents/update_cancel";
            fetch(page_url, {
              method: "POST",
