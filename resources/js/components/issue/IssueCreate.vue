<template>
        ...
        <div class="container-fluid ml-0">
          <div class="row">
            ...
            <!-- <h5 class="m-0 text-dark"><i class="fa fa-home"></i>Hợp đồng / Tạo</h5> -->
             <ol class="breadcrumb ">
              <li class="breadcrumb-item"> <h5 class="m-0 text-dark"><i class="nav-icon fas fa-file-contract"></i> <a href="documents">{{ $t(pre_title)}}</a> </h5></li>
           ...
           <div class="row">
              <div class="col-md-12">
                  ...
                  <div class="form-group row">
                    <label for="" class="col-form-label-sm col-sm-2 col-form-label  text-md-right"  >{{ $t('form.document_num')}}</label>
                    <div class="col-md-8">
                   ...
                   <div class="form-group row" v-show="showControl('title')">
                    <label for="title" class="col-form-label-sm col-sm-2 col-form-label  text-md-right"  >{{$t('form.about')}}<small v-if="showValidate('title')"    class="text-red">( * )</small></label>
                    <div class="col-sm-8">
                  ...
                  <div class="form-group row"  v-show="showControl('budget_num')">
                    <label for="budget_num" class="col-form-label-sm col-sm-2 col-form-label  text-md-right" >{{$t('form.budget_code')}}<small v-if="showValidate('budget_num')"    class="text-red">( * )</small></label>
                    <div class="col-sm-3">

                      <input type="text"  v-model="document.budget_num"  class="form-control form-control-sm "
                          v-bind:class="hasError('budget_num')?'is-invalid':''"
                              ...
                              />
                            <span v-if="hasError('budget_num')" class="invalid-feedback" role="alert">
                   ...
                   <div class="form-group row"  v-if="showControl('amount')">
                    <label for="amount" class="col-form-label-sm col-sm-2 col-form-label  text-md-right"  > <span v-html="showLabel('amount',$t('form.amount'))"></span> <small v-if="showValidate('amount')"   class="text-red">( * )</small></label>
                    <div class="col-sm-3">
                        ...
                        <vue-numeric  style="text-align: right"
                        :separator="separator"
                        ...
                        v-bind:class="hasError('amount')?' form-control form-control-sm is-invalid':'form-control form-control-sm'"></vue-numeric>
                   ...
                   <div class="form-group row" v-show="showControl('budget_type')" >
                      <label for="" class="col-form-label-sm col-sm-2 col-form-label " ></label>
                      <div class="col-sm-8">
                        <b-form-radio-group
                  ...
                  <div class="form-group row" v-if="showControl('doc_type_id')">
                      <label for="doc_type_id" class="col-form-label-sm col-sm-2  text-md-right" >{{$t('form.doc_type')}}<small  v-if="showValidate('doc_type_id')"   class="text-red">( * )</small></label>
                      <div class="col-sm-3">
                        ...
                        <option key=""></option>
                        <option v-for="doc_type in doc_types" v-bind:key="doc_type.id"   v-bind:value="doc_type.id">{{doc_type.name}}</option>
                      </select>
                        <span v-if="hasError('doc_type_id')" class="invalid-feedback" role="alert">
                   ...
                   <div class="form-group row">
                    <label for="content" class="col-form-label-sm col-sm-2 col-form-label  text-md-right" >{{$t('form.content')}}<small  v-if="showValidate('content')"    class="text-red">( * )</small></label>
                    <div class="col-sm-8">
                        <ckeditor
  ...
  <div class="form-group row">
                      <label for="content" class="col-form-label-sm col-sm-2 col-form-label  text-md-right"  >{{$t('form.choose_file')}}<small   class="text-red"></small></label>
                      <div class="col-sm-8">
                                <button type="button"  title="chọn file" class="btn btn-xs btn-outline " v-on:click="handleClickInputFile()">
                    ...
                    <div class="form-group row">
                      <label for="group_id" class="col-form-label-sm col-sm-2 text-md-right"  >{{$t('form.group')}}<small    class="text-red">( * )</small></label>
                      <div class="col-sm-3">
                      ...
                      <label for="group_id" class="col-form-label-sm col-sm-2 text-md-right"  >Được xem</label>
                      <div class="col-sm-3">
                        <!-- <select name="group_id" id="group_id"
                        v-model="document.group_id"
                          v-bind:class="hasError('group_id')?'is-invalid':''"
                       ...
                       <treeselect  placeholder="" :disable-branch-nodes="true" :multiple="true" v-model="document.shared_groups"    :options="tree_groups" />
                     ...
                     <div class="form-group row">
                      ...
                      <label for="group_id" class="col-form-label-sm col-sm-2 text-md-right"  >Bộ phận xử lý <small class="text-red">( * )</small></label>
                      <div class="col-sm-3">

                       <treeselect  placeholder="" :disable-branch-nodes="true"  v-model="document.process_group_id"    :options="tree_groups" />

                        <span v-if="hasError('process_group_id')" class="invalid-feedback" role="alert">
                          <strong>{{getError('process_group_id')}}</strong>
                      </span>
                      </div>
                    </div>
                    <approve-add-user v-on:updateUser="updateUser" :team="document.team" :user_id="user_id"  eventname="updateUser" :layout ="layout" :list_user="users"  v-if="showControl('add_user')"></approve-add-user>
              </div>
...
export default {
	components: { ApproveAddUser , Treeselect},
  created () {
      ...
      if( this.id != ""){
          ...
          if(res.data.success == '1'){
              ...
              this.document.shareds.forEach(shared => {
                 this.document.shared_groups.push(shared.group_id);
              });
