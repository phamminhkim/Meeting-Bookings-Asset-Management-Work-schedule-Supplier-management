  ...
  <div>
    ...
    <div class="row">
        <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group row" v-if="showControl('amount')">
                            ...
                            <div class="col-sm-10">
                                <label class="col-form-label-sm">{{document.amount.toLocaleString(locale_format)}} VNĐ</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <span class="col-form-label-sm col-sm-2 ">Được xem</span>
                            <div class="col-sm-10">
           ...
           <reminder-list v-bind:object="document" :items_props="document.reminders" v-on:reminderAction="reminderAction"   :type="'ISSUE'"></reminder-list>
    ...
    <create-event-dialog :object_id="object_id" v-on:fromReminder="fromReminder" :id="reminder_id"  module="ISSUE"></create-event-dialog>
  </div>
</template>
...
export default {
  data () {
    return {
      ...
      //   ],
       ...
       page_url_document_print :"/issue/print",
    }
  },
    watch: {
    document(){
  ...
  methods: {
   ...
   editDocument(){
    ...
    window.location.href= "issues?type=edit&id="+this.id;
    },
    fromReminder(obj){
