    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-sm-6">
            <create-new-menu
              url="price/requests?type=add&doctype="
              module="PRICE"
            ></create-new-menu>
            ...
            <div class="row mt-0">
              <div class="col-md-9">
                <div class="form-group row">
                  ...
                  <span v-if="save_filter" :title="$t('form.filter')" class="ml-1"
                    ><i class="fas fa-filter" :title="$t('form.filter')"></i
                  ></span>
                </div>
              </div>
              <div class="col-md-3">
            ...
            >
              <div class="col-sm-12">
                <div class="form-group row">
                  ...
                  <label
                    class="col-form-label-sm col-sm-2 col-form-label text-left text-md-right"
                    :title="$t('form.serial_num')"
                    for=""
                    >{{ $t("form.serial_num") }}</label
                  >
                  <div class="col-sm-2">
                    <input
                      type="text"
                ...
                <div class="form-group row">
                  ...
                  >
                  <div class="col-sm-10">
                     <treeselect id="document_type_id" :disabled="edit"
                                                    :disable-branch-nodes="true"
                                                    v-model="form_filter.document_type_id"
...
<label
                ...
                <div class="form-group row">
                  ...
                  <label
                    class="col-form-label-sm col-sm-2 col-form-label text-left text-md-right"
                    for="miss_invoice"
                    >{{ $t("form.document_by") }}</label
                  >
                  <div class="col-md-2">
                    <select
                      name=""
                      id=""
                      v-model="form_filter.visibility"
                      class="form-control form-control-sm mt-1"
                    >
              ...
              <div class="col-md-9">
                <div class="form-group row">
                  ...
                  <button
                    ...
                    @click="editRequest()"
                  >
                    <i class="fas fa-edit" :title="$t('form.edit')"></i
                    >{{ $t("form.edit") }}
                  </button>
            ...
            <div class="active tab-pane" id="yeucaumoi">
              <div class="row">
                <b-table
                  ...
                  :per-page="per_page"
                  :filter="filter"
                  :filter-included-fields="['title', 'serial_num']"
                  selectable
                  ref="selectableTable"
                ...
                >
                  ...
                  <template v-slot:cell(serial_num)="data">
                    <div class="d-flex justify-content-between">
                      ...
                      <b-button
                        ...
                        v-if="data.item.reminders && data.item.reminders.length > 0"
                        variant="link"
                      ...
                      >
                        ...
                        <span
                          v-for="reminder in data.item.reminders"
                  ...
                  <template v-slot:cell(newtab)="data">
                    <a target="_blank" :href="viewRequest(data.item.id)"
                      ><i title="View in new tab" class="fas fa-external-link-alt"></i
                    ></a>
                  </template>
                  ...
                  <template v-slot:cell(miss_invoice)="data">
                    <div style="text-align: center">
                      <input
                        type="checkbox"
                        v-model="data.item.miss_invoice"
                  ...
                  <template #cell(date_receive_hard_doc)="data">
                    <div class="d-flex justify-content-between">
                      <span>{{ data.value | formatDateDB }}</span>
                      <!-- <a href="#" @click.prevent="change_date_receive_hard_doc(data.item)"><i class="far fa-calendar"></i></a> -->
                    </div>
                  </template>
                  ...
                  <template #cell(status)="data">
                    ...
                    <span v-else-if="data.value == 1" class="badge badge-secondary"
                      >{{ $t("Đang xử lý") }}
                    </span>
                    <span v-else-if="data.value == -1" class="badge bg-danger"
                      >{{ $t("Đã huỷ") }}
                    </span>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group row">
                      <label
                        class="col-form-label-sm col-md-4"
...
export default {
  ...
  data() {
    return {
      ...
      locale_format: "de-DE",
      tableData: [],
      fileName: "DS_YCDG_" + moment(Date()).format("MM/DD/YYYY"),
      fieldexcel: {
      ...
      fields: [
        ...
        {
          key: "effective_date",
          label: this.$t("form.effective_date"),
          sortable: true,
          stickyColumn: true,
          class: "text-center text-nowrap",
        },
      ...
      edit: false,
      token: "",
      page_url_request: "/api/price/requests",
  ...
  methods: {
    ...
    init() {
      ...
      this.form_filter.document_type_id = [];
      //variant:
    ...
    fetDocumentType() {
      ...
      var page_url = this.page_url_document_type + "?module=PRICE";
     ...
     fetDocumentTypes_Tree() {
            // const this.token = "Bearer " + window.Laravel.access_this.token;
            var page_url = this.page_url_document_type + "?module=PRICE&type=tree_combobox";
            fetch(page_url, { headers: { Authorization: this.token } })
                .then((res) => res.json())
                .then((res) => {
                    //console.log("Xin chao");
    ...
    showAdd(code) {
      window.location.href = "price/requests?type=add&doctype=" + code;
    },
        ...
        .then((res) => {
          ...
          if (res.success == "1") {
            ...
            for (let i = 0; i < this.requests.length; i++) {
              ...
              var effective_date = "";
              if (this.requests[i].effective_date != null) {
                effective_date = moment(this.requests[i].effective_date).format(
                  "MM/DD/YYYY"
                );
              } else {
                effective_date = "";
              ...
              var created_at = "";
              if (this.requests[i].created_at != null) {
                created_at = moment(this.requests[i].created_at).format("MM/DD/YYYY");
              } else {
                created_at = "";
              }
              var send_date = "";
    ...
    editRequest() {
      ...
      window.location.href = "price/requests?type=edit&id=" + id;
    },
    viewRequest(id) {
      //window.location.href= "payment/requests?type=view&id="+id;
      return "price/requests?type=view&id=" + id;
    },
      viewTeam(id) {
      //window.location.href= "payment/requests?type=view&id="+id;
    ...
    cancelRequest() {
      ...
      this.$bvModal
        ...
        .then((value) => {
          if (value) {
            var page_url = "/api/price/update_cancel";
            fetch(page_url, {
              method: "POST",
