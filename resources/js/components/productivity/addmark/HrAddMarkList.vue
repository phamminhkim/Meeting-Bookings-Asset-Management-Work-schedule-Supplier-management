<template>
  <div>
            ...
            <div class="row mt-1" style="background-color: #f4f6f9">
              <div class="col-md-9">
                <div class="form-group row">
                  ...
                  <!-- <button type="button" class="btn btn-danger  btn-sm ml-1 mt-1" :title="$t('form.delete')"  @click.prevent="deleteHrAddMark()" ><i class="fas fa-trash-alt" :title="$t('form.delete')"></i> {{$t('form.delete')}} </button> -->
                  <button type="button" class="btn btn-danger btn-sm ml-1 mt-1" :title="$t('form.cancel')"
                    @click.prevent="deleteHrAddMark()">
                  ...
                  <template v-slot:cell(files)="data">
                    <div class="d-flex justify-content-between">
                      <ul class="list-unstyled">
                        <li v-for="(file, index) in data.item.attachment_file" v-bind:key="index" class="itemfile">
                          <div class="btn-group">
    ...
    <!-- dialog -->
    <HrAddMarkCreateDialog :id="selected[0]" v-on:fromhraddmark="fromhraddmark"></HrAddMarkCreateDialog>
...
import HrAddMarkCreateDialog from "./HrAddMarkCreateDialog.vue";
export default {
  props: {
    title: "",
  },
  components: { Treeselect, Loading, HrAddMarkCreateDialog },
  data() {
    return {
      variant_name: "productivity_HrAddMarkList",
      ...
      edit: false,
      token: "",
      page_url_request: "/api/productivity/addmark",
