<template>
  <div class="modal fade" id="modalUploadDaysOff" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content card">
        ...
        <div class="modal-body">
          <b-overlay :show="loading" rounded="sm">
            ...
            <div class="form-group row">
              <label for="title" class="col-form-label-sm col-sm-2 col-form-label text-md-right">Tải lên file ngày nghỉ</label>
              <div class="col-sm-8">
        ...
        <div class="modal-footer">
          <button type="button" @click.prevent="uploadDaysOff()" :disabled="uploadData.length == 0"
  ...
  data() {
    return {
      template: [
        ...
        { field: 'date_off', label: 'Ngày nghỉ', type: 'date', width: "80px", sticky: true, textAlign: 'center' },
        { field: 'reason', label: 'Lí do nghỉ', type: 'string', width: "160px", sticky: true }
      ],
      uploadData: [],
      errors: {},
      loading: false,
      token: "",
      page_url_dayoff_upload: "/api/productivity/dayoffUpload",
    };
  },
  methods: {
    uploadDaysOff() {
      this.loading = true;
      var page_url = this.page_url_dayoff_upload;
      fetch(page_url, {
        method: "post",
        body: JSON.stringify({
    ...
    exportDataAsFile() {
      var fileName = "Template ngày nghỉ";
