<template>
  <div>
          ...
          <div class="col-sm-6">
            ...
            <div class="float-sm-right">
              <div class="btn-group-vertical ">
                <button class="btn btn-primary" @click="uploadDaysOff()"> Cập nhật hàng loạt </button>
    ...
    <!-- dialog -->
    <HrAddDayoffCreateDialog :id="selected[0]" v-on:fromhraddmark="fromhraddmark"></HrAddDayoffCreateDialog>
    <dialog-day-off-upload title="Upload dữ liệu ngày nghỉ" v-on:onUploadData="onUploadData"></dialog-day-off-upload>
...
import HrAddDayoffCreateDialog from "./HrAddDayoffCreateDialog.vue";
import DialogDayOffUpload from './DialogDayOffUpload.vue';
export default {
  props: {
    title: "",
  },
  components: { Treeselect, Loading, HrAddDayoffCreateDialog, DialogDayOffUpload },
  data() {
    return {
      variant_name: "productivity_HrDayoffList",
      ...
      edit: false,
      token: "",
      page_url_request: "/api/productivity/dayoff",
  ...
  methods: {
    ...
    editDocument() {
      ...
      $("#hrAddDayoffDialogID").modal("show");
    },
    newHrAddMark() {
