            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <button  class="btn btn-info btn-sm" @click="showGoodtypes()"> <i class="fa fa-plus"></i>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group row">
                                            <label class="col-form-label-sm col-md-1 " style="text-align:left"
                                                :title="$t('form.employee_code')" for=""> Mã Loại Hàng</label>
                                            <div class="col-md-3">
                                                <input type="text" v-model="form_filter.code"
                                                    class="form-control form-control-sm mt-1">
                                            </div>
                                            <label class="col-form-label-sm col-md-1" style="text-align:left"
                                                :title="$t('form.employee_name')" for="">Tên Loại Hàng</label>
                                            <div class="col-md-3">
                                ...
                                <div class="row">
                                    <b-table ref="table" striped hover bordered responsive head-variant="light" small
                                        :fields="fields" :items="goodtypes" :filter="filter"
                                        :current-page="current_page" :per-page="per_page" :tbody-tr-class="rowClass">
                                        <template v-slot:cell(code)="data">
                                            <span><a href="#"
                                                    @click.prevent="viewGoodtypess(data.item.id)">{{ data.item.code }}</a></span>
                                        </template>
                                        <template #cell(action)="data">
                                            <div class="margin">
                                                <button class="btn btn-xs" @click="editGoodtypes(data.item)"><i
                                                        class="fas fa-edit text-green " title="Edit"></i></button>

                                                <button class="btn btn-xs" @click="deleteGoodtypes(data.item.id)"><i
                        ...
                        <form @submit.prevent="AddGoodtypes">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label>Mã</label><small class="text-red">( * )</small>
                                    <input class="form-control" v-model="goodtypess.code" 
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" v-model="goodtypess.name"
                                ...
                                <div class="form-group">
                                    <label>Mô Tả</label>
                                    <input class="form-control" v-model="goodtypess.description" />
                                </div>
    ...
    methods: {
        ...
        AddGoodtypes() {
            ...
            if (this.edit === false) {
                fetch(page_url, {
                    method: "POST",
                    body: JSON.stringify(this.goodtypess),
                    headers: {
                ...
                //update
                fetch(page_url + "/" + this.goodtypess.id, {
                    method: "PUT",
                    body: JSON.stringify(this.goodtypess),
                    headers: {
                        Authorization: this.token,
                    ...
                    .then(data => {
                        ...
                        if (!data.data.errors) {
                            ...
                            this.$set(this.goodtypes, this.goodtypess.index, { ...this.goodtypess });
        ...
        editGoodtypes(goodtypess) {

            let index = this.goodtypes.findIndex(i => {
                console.log("id" + i.id);
                return i.id == goodtypess.id;
            });
            this.edit = true;
            this.goodtypess.id = goodtypess.id;
            this.goodtypess.description = goodtypess.description;
            this.goodtypess.code = goodtypess.code;
            this.goodtypess.name = goodtypess.name;
            this.goodtypess.index = index;
            $("#AddGoodtypes").modal("show");
        },
        deleteGoodtypes(id) {
                ...
                .then(res => {
                    if (res.success == '1') {
                        ...
                        for (let i = 0; i < this.goodtypes.length; i++) {
                            list.push({
                                So_thu_tu: i,
                                Ten_hang: this.goodtypes[i].name,
                                Mo_ta: this.goodtypes[i].description,
                                Ma_code: this.goodtypes[i].code,
        ...
        reset() {
            this.clearAllError();
            this.edit = false;
            for (let field in this.goodtypess) {
                this.goodtypess[field] = null;
            }
        },
        clearAllError() {
            this.errors = {};
