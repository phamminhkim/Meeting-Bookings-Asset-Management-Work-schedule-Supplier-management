...
<div class="page-content">
  ...
  <form class="form-horizontal" action="{{route('adminpermissions.store')}}" method="POST" role="form">
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="form-group">
          <label class="col-sm-3 control-label no-padding-right" for="name"> Tên Permission </label>

          <div class="col-sm-9">
            <input type="text" id="name" name="name" placeholder="Nhập tên Permission" required class="col-xs-10 col-sm-5">
          </div>
        </div>
        <div class="form-group">
