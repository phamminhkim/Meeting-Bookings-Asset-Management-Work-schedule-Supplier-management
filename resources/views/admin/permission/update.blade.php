...
<div class="page-content">
    <div class="page-header">
        <h1>
            Cập nhật Permissions</h1>
    </div><!-- /.page-header -->
    <form class="form-horizontal" action="{{route('adminpermissions.update', $getPermissionByID[0]->id)}}" method="POST" role="form">
        @method('PUT')
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="name" name="name" value="{{ $getPermissionByID[0]->name }}" placeholder="Nhập tên Role" required class="col-xs-10 col-sm-5">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="description" name="description" placeholder="Nhập Mô tả" value="{{ $getPermissionByID[0]->description }}" class="col-xs-10 col-sm-5">
                    </div>
                </div>
                ...
                <div class="clearfix">
                    <div class="col-md-offset-3 col-md-9">
                        ...
                        &nbsp; &nbsp; &nbsp;
                        <a class="btn" href="{{route('adminpermissions.index')}}" type="button">
