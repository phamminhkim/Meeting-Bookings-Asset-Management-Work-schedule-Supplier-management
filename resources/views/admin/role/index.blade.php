                ...
                <div class="clearfix">
                    <div class="pull-left tableTools-container">
                        <div class="dt-buttons btn-overlap btn-group">
                            ...
                            <a href="{{ route('adminroles.create') }}" class="btn btn-success"> <i class=" fa fa-pencil-square-o bigger-110"> Tạo mới </i></a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        @if($role->name == 'admin' || $role->name == 'user' || $role->name == 'leader')
                                        No action
                                        @else
                                        <a class="green" href="{{route('adminroles.edit',$role->id)}}">
