...
<div class="page-content">
    ...
    <form class="form-horizontal" action="{{route('adminroles.update', $getRolesById[0]->id)}}" method="POST" role="form">
        @method('PUT')
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="name" name="name" value="{{ $getRolesById[0]->name }}" placeholder="Nhập tên Role" required class="col-xs-10 col-sm-5">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="description" name="description" placeholder="Nhập Mô tả" value="{{ $getRolesById[0]->description }}" class="col-xs-10 col-sm-5">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="radio">
                            <label>
                                <input name="active" value="1" @if($getRolesById[0]->active =='1') checked @endif checked type="radio" class="ace">
                                <span class="lbl"> Đang hoạt động</span>
                            </label>
                            <label>
                                <input name="active" value="0" @if($getRolesById[0]->active =='0') checked @endif type="radio" class="ace">
                ...
                <div class="tabbable tabs-left">
                    ...
                    <div class="tab-content">
                        <div id="menu" class="tab-pane active">
                            @include('admin.role.tabs.tab_menu_edit')
                        </div>

                        <div id="permission" class="tab-pane">
                            @include('admin.role.tabs.tab_permission_edit')

                        </div>

                        <div id="sloc" class="tab-pane">
                            @include('admin.role.tabs.tab_sloc_edit')
...
<script>
    ...
    function init() {
        ...
        $('input[name="quyenids[]"]').each(function() {
            quyenids.push($(this).val());
        });
        $('input[name="slocids[]"]').each(function() {
            slocids.push($(this).val());
        });
