...
<div class="page-content">
        ...
        @if($type == 'add')
          <calendar-create title="{{$menucurr->title}}" 
          ></calendar-create>
        @elseif($type == 'edit')
            <calendar-create title="{{$menucurr->title}}"  id={{$id}}
             
            ></calendar-create>
        @elseif($type == 'view')
        <calendar-details title="{{$menucurr->title}}" notification_id="{{$notification_id}}"  id={{$id}}></calendar-details>
       
        @else
        <calendar title="{{$menucurr->title}}"></calendar>
        @endif
</div>
