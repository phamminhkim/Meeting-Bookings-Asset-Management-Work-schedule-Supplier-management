			...
			<div class="callout callout-info" >	
				...
				<div class="callout callout-info" >	
					...
					<div @if($car->status==-2 && $result['is_step3']==3)
							...
							@endif">
							<p style="text-align:center;"> <strong>{{ Ultils::is_position($result['is_user_id_step3']) }}</strong></p>
							<p style="text-align:center; line-height:25px;">
							{{$result['is_user_step3'] }}
							</p>
							<p style="text-align:center;">
							{{ $result['is_checkout_step3']}}
							</p>
					</div>
					</td>
					 </tr>
