...
<div class="page-content">
        @if($type == 'add')
           @if( $contract_type == '3')
            <contract-create-one parent='{{$parent}}' company_id='{{$company_id}}' id=''></contract-create-one>
           ...
           @endif
        @elseif($type == 'edit')
        <contract-create-one id='{{$id}}' company_id='{{$company_id}}' ></contract-create-one>
        @elseif($type == 'view')
        <contract-detail id='{{$id}}' ></contract-detail>
        @elseif($type == 'run')
