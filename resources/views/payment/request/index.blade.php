...
<div class="page-content">
        ...
        @if($type == 'add')
          <pay-request-create title="{{$menucurr->title}}"  :layout ="{{json_encode($layout)}}" pre_title="{{$doctype_name}}" user_id='{{Auth()->user()->id}}' doctype='{{$doctype}}' doctype_id='{{$doctype_id}}'  id=''
          ></pay-request-create>
        @elseif($type == 'edit')
            <pay-request-create title="{{$menucurr->title}}"  pre_title="{{$doctype_name}}" user_id='{{Auth()->user()->id}}' doctype='{{$doctype}}' doctype_id='{{$doctype_id}}'   id={{$id}}
        ...
        @elseif($type == 'view')
        <pay-request-detail  notification_id="{{$notification_id}}"  :layout ="{{json_encode($layout)}}" pre_title="{{$doctype_name}}" pre_url="payment/requests" user_id={{Auth()->user()->id}} id={{$id}}></pay-request-detail>
        @elseif($type == 'print')
        ...
        @else
        <pay-request title="{{$menucurr->title}}"></pay-request>
        @endif
</div>
