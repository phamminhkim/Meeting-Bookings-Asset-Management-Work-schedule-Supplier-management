...
<div class="page-content">
        ...
        <test-detail notification_id="{{$notification_id}}"    :form_title='"{{$form_name}}"'   pre_title="{{$doctype_name}}" pre_url="documents" user_id={{Auth()->user()->id}} id={{$id}}></test-detail>
        @elseif($type == 'print')

        @else
        <system-car title="{{$menucurr->title}}"></system-car>
        @endif
